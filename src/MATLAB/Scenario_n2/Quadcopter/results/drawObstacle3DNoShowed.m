function drawObstacle3DNoShowed(xObs,yObs,dSafe)
...
fill3(x, y, z_ground, [0.706, 0.706, 0.722], 'FaceAlpha', 1, 'EdgeColor', 'none', 'HandleVisibility','off');

% Plot the position of the obstacle with a cross without showing any label
% in the legend
plot(xObs, yObs, 'kx','HandleVisibility','off');
