...
load('out_epsilon_circle_2Obstacles_3rdTime.mat');
% + the resulting state related to the ground robot simulation
load('UGVState_10cm_2obstacles.mat')
...
% x,y,z, and psi of the quadcopter reference over the simulation sampled
% every 0.1 seconds
Reference = reshape(out.Ref.Data,[3,601]);
...
% every 0.1 seconds
XUAVBar = reshape(out.XUAVbar.Data,[12,601])';
